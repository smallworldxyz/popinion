//! Project persistence (port of models/project.py).
//! One directory per project under ./uploads/projects/<project_id>/ with
//! metadata.json + extracted_text.txt — same layout as the Python backend, so
//! the simulation/report subsystems can share it.
