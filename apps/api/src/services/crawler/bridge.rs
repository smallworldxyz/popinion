//! Bridge scraped real-world data into simulation agent profiles.
//! Inference is deterministic (keyed off user_id / bio keywords) instead of
//! random, so seeds are reproducible.
