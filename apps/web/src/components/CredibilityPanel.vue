...
.swatch-synthetic {
  background: repeating-linear-gradient(45deg, #D1D5DB, #D1D5DB 3px, #F3F4F6 3px, #F3F4F6 6px);
...
.agree-figure.ok { color: #166534; }
.agree-figure.warn { color: #B45309; }
.agree-figure.bad { color: #B91C1C; }
